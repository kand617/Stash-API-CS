...
namespace StashAPI.PCL.Controllers
{
    public partial class ProfileController: BaseController
    {
        ...
        /// </summary>
        internal static ProfileController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// <param name="permission">Optional parameter: (optional) if specified, it must be a valid repository permission level name and will limit                    the resulting repository list to ones that the requesting user has the specified permission                    level to. If not specified, the default <code>REPO_READ</code> permission level will be assumed.</param>
        /// <return>Returns the string response from the API call</return>
        public async Task<string> GetProfileRepositoriesRecentlyAccessedAsync(string permission = null)
        {
            ...
            _queryBuilder.Append("/api/1.0/profile/recent/repos");
